...
function [Gamma1, Gamma2]= computeGamma(L, F, pitchBounds, ...
    ...
    for l = 1:L
        ...
        elseif l == 2
            ...
            ll = l-1;
            [R1, phiout, psiout, alpha1, gammaOldout, gammaNewout] = ...
            ...
            gammaNew1(1:l,1:size(gammaNewout,2)) = gammaNewout;
            gammaOld1(1:l-1,1:size(gammaOldout,2)) = gammaOldout;
            [R2, phiout, psiout, alpha2, gammaOldout, gammaNewout] = ...
            computeGammaMultipleSinus(...
            ...
            gammaNew2(1:l,1:size(gammaNewout,2)) = gammaNewout;
            gammaOld2(1:l-1,1:size(gammaNewout,2)) = gammaOldout;
